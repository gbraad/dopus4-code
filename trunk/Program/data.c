...
struct LayersBase *LayersBase = NULL;       /* layers.library */
...
struct RxsLib *RexxSysBase = NULL;          /* rexxsyslib.library */
struct Library *AccountsBase = NULL;        /* accounts.library */
struct UtilityBase *UtilityBase = NULL;     /* utility.library */
...
struct RastPort *font_rp=NULL;            /* Font window RastPort */
...
ULONG data_window_refresh=0;              /* Windows that need refreshing */
...
struct Requester dopus_busy_requester={0};    /* Busy requester */
