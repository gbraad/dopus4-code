...
struct ConfigGadget
    ...
    op_generalgadgets[]={
        ...
        {CTYPE_GAD,0,STR_OP_GENERAL_FMPARENTMODE,247,-1,-1,-1,16,0},
        {CTYPE_GAD,0,STR_OP_GENERAL_FORCEQUIT,247,-1,-1,-1,32,0},
        {0,0,-1}},
    op_icongadgets[]={
...
extern USHORT glass_data[2][];
extern USHORT uparrow_data[];
extern USHORT downarrow_data[];
