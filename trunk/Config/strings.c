...
struct DefaultString
    default_strings[]={
        ...
        "Select an item in the menu to copy the original menu to."},
        ...
        {STR_OP_UPDATE_QUIETGETDIR, //HUX
        "Update listview slider while scanning"}, //HUX
        ...
        {STR_SIZE_KMGMODE, //HUX
        "Show size in K/M/G"}, //HUX

        {STR_SYS_VIEWPLAY_INWINDOW,
        "View in window"}, //HUX
        ...
        {STR_CLASSOPS_MATCHI,
        "MatchI       - text (case-insensitive)"}, // JRZ

        {STR_MENU_MAX_REACHED,                     // JRZ
        "Warning! Some menus were not imported due to lack of free space."},

        {STR_OP_GENERAL_FMPARENTMODE,              // JRZ
        "FileMaster-like Parent"},

        {STR_OP_COPY_COPYARCHIVE,    // JRZ
        "Copy archive bit too"},

        {STR_OP_GENERAL_FORCEQUIT,              // JRZ
