...
enum {
    ...
    STR_FUNCTION_COMMAND=579,
    STR_FUNCTION_AMIGADOS=580,
    STR_FUNCTION_WORKBENCH=581,
    STR_FUNCTION_BATCH=582,
    STR_FUNCTION_AREXX=583,
    STR_MODE_WORKBENCH_CLONE=585,
    STR_MODE_WORKBENCH_USE=586,
    STR_COLOURS_TINY_GADS=587,
    STR_FORMAT_GROUPBITS=588,
    STR_MENUNAME_NEATSTUFF=589,
    STR_NEAT_PAINT_MODE=590,
    STR_PAINT_SELECT_COLOURS=591,
    STR_PAINT_STATE=592,
    STR_SCREEN_GENERAL_TITLEBARSTATUS=594,
    STR_OP_UPDATE_PROGRESSIND_COPY=595,
    STR_SCREEN_MODE_USE=596,
    STR_SCREEN_GENERAL_WINDOWBORDERS=597,
    STR_SCREEN_MODE_CLONE=598,
    STR_SCREEN_SLIDERS=599,
    STR_OP_UPDATE_PROGRESS=600,
    STR_FONTPLACE_SCREEN=601,
    STR_FUNCTIONLIST_SETVAR=602,
    STR_COMMANDSEQ_VARIABLE=603,
    STR_SYS_VIEWPLAY_BESTMODEID=604,
    STR_FUNCTIONLIST_NOTIFY=605,
    STR_FUNCTIONLIST_PARENTLIST=606,
    STR_SIZE_KMGMODE=607,
    STR_SYS_VIEWPLAY_INWINDOW=608,
    STR_SYS_TOP_Y=609,
    STR_SYS_LEFT_X=610,
    STR_SYS_WIDTH=611,
    STR_SYS_HEIGHT=612,
    STR_CLASSOPS_MATCHI=613,
    STR_MENU_MAX_REACHED=614,
    STR_OP_GENERAL_FMPARENTMODE=615,
    STR_OP_COPY_COPYARCHIVE=616,
    STR_OP_GENERAL_FORCEQUIT=617,
    STR_USE=618,
