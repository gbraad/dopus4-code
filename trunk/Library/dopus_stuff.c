...
*/
    "PROGDIR:C/",         "C:",   "DOpus:C/",
    "PROGDIR:S/",         "S:",   "DOpus:S/",
    "PROGDIR:Libs/",      "LIBS:","DOpus:Libs/",
    "PROGDIR:Rexx/",      "REXX:","DOpus:Rexx/",
    "PROGDIR:Modules/",   "C:",   "DOpus:Modules/",
    "PROGDIR:Requesters/","S:",   "DOpus:Requesters/"
};
    ...
    if (/*DOSBase->dl_lib.lib_Version<36 ||*/ //JRZ
        ...
        if (DoCheckExist(temp,NULL)>=0) {
            ...
            for (a=0;a<3;a++) {                                  // JRZ: was 2
                DoStrCombine(temp,look_dirs[(type*3)+a],name,256); // JRZ: was 2

                if (DoCheckExist(temp,NULL)<0) break;
            }
            if (a==3) temp[0]=0;                                 // JRZ: was 2
