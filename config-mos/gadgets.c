...
CONST struct ConfigGadget op_copygadgets[] =
{
	{CTYPE_MOVE, 0, -1, 20},
...
struct Gadget editfuncgadgets[15] = {
	{&editfuncgadgets[1], 256, 54, 140, 8,
	 ...
	 GTYP_STRGADGET, NULL, NULL, NULL, 0, (APTR) & namesinfo, EDIT_NAME,
	 NULL},
	...
	{&editfuncgadgets[7], 530, 142, 80, 8,
	 GFLG_GADGHCOMP | GFLG_STRINGEXTEND | GFLG_TABCYCLE,
	 GACT_RELVERIFY | GACT_TOGGLESELECT | GACT_LONGINT,
	 GTYP_STRGADGET, NULL, NULL, NULL, 0, (APTR) & stacksinfo, EDIT_STACK,
	 NULL},
	{&editfuncgadgets[8], 530, 156, 80, 8,
	 GFLG_GADGHCOMP | GFLG_STRINGEXTEND | GFLG_TABCYCLE,
	 GACT_RELVERIFY | GACT_TOGGLESELECT | GACT_LONGINT,
	 GTYP_STRGADGET, NULL, NULL, NULL, 0, (APTR) & prioritysinfo,
	 EDIT_PRIORITY, NULL},
	{&editfuncgadgets[9], 530, 170, 80, 8,
	 GFLG_GADGHCOMP | GFLG_STRINGEXTEND | GFLG_TABCYCLE,
	 GACT_RELVERIFY | GACT_TOGGLESELECT | GACT_LONGINT,
	 GTYP_STRGADGET, NULL, NULL, NULL, 0, (APTR) & delaysinfo, EDIT_DELAY,
	 NULL},
	...
	{&editfuncgadgets[12], 291, 126, 287, 8,
	 GFLG_GADGHCOMP | GFLG_STRINGEXTEND | GFLG_TABCYCLE,
	 GACT_RELVERIFY | GACT_TOGGLESELECT,
	 GTYP_STRGADGET, NULL, NULL, NULL, 1, (APTR) & funcsinfo, EDIT_FUNC,
	 NULL},
	{NULL, 586, 123, 28, 14,
	 GFLG_GADGHCOMP, GACT_RELVERIFY,
	...
	{&editfuncgadgets[14], 177, 69, 433, 8,
	 GFLG_GADGHCOMP | GFLG_STRINGEXTEND | GFLG_TABCYCLE,
	 GACT_RELVERIFY | GACT_TOGGLESELECT,
	 GTYP_STRGADGET, NULL, NULL, NULL, 0, (APTR) & actionsinfo,
	 EDIT_FILETYPEACTION, NULL},
	{NULL, 486, 31, 128, 14,
	 GFLG_GADGHCOMP, GACT_RELVERIFY,
...
{
	{
	&editdrivegadgets[1], 248, 112, 140, 8, GFLG_GADGHCOMP | GFLG_STRINGEXTEND | GFLG_TABCYCLE, GACT_RELVERIFY | GACT_TOGGLESELECT, GTYP_STRGADGET, NULL, NULL, NULL, 0, (APTR) & namesinfo, DRIVE_EDITNAME, NULL},
	{
	&editdrivegadgets[2], 488, 138, 104, 12, GFLG_GADGHCOMP, GACT_RELVERIFY | GACT_TOGGLESELECT, GTYP_BOOLGADGET, NULL, NULL, NULL, 0, NULL, DRIVE_EDITSAMPLE, NULL},
	{
	&editdrivegadgets[3], 150, 123, 28, 14, GFLG_GADGHCOMP, GACT_RELVERIFY, GTYP_BOOLGADGET, NULL, NULL, NULL, 0, NULL, DRIVE_EDITREQ, NULL},
	{
NULL, 186, 126, 294, 8, GFLG_GADGHCOMP | GFLG_STRINGEXTEND | GFLG_TABCYCLE, GACT_RELVERIFY | GACT_TOGGLESELECT, GTYP_STRGADGET, NULL, NULL, NULL, 1, (APTR) & pathsinfo, DRIVE_EDITPATH, NULL}}, menuslidergads[3] =

{
	{
	&menuslidergads[1], 616, 34, 8, 142 - HIDDENLINES * 8, GFLG_GADGHNONE, GACT_IMMEDIATE | GACT_FOLLOWMOUSE | GACT_RELVERIFY, GTYP_PROPGADGET, (APTR) & menusliderimage, NULL, NULL, 0, (APTR) & menusliderprop, MENU_SLIDER, NULL},
	{
	&menuslidergads[2], 612, 130, 16, 8, GFLG_GADGHCOMP, GACT_IMMEDIATE | GACT_RELVERIFY, GTYP_BOOLGADGET, NULL, NULL, NULL, 0, NULL, MENU_MOVEUP, NULL},
	{
NULL, 612, 138, 16, 8, GFLG_GADGHCOMP, GACT_IMMEDIATE | GACT_RELVERIFY, GTYP_BOOLGADGET, NULL, NULL, NULL, 0, NULL, MENU_MOVEDOWN, NULL}}, palettegads[6] =

{
	{
	&palettegads[1], 300, 65, 216, 8, GFLG_GADGHNONE, GACT_IMMEDIATE | GACT_FOLLOWMOUSE | GACT_RELVERIFY, GTYP_PROPGADGET, (APTR) & paletteimage[0], NULL, NULL, 0, (APTR) & paletteprop[0], PALETTE_SLIDER, NULL},
	{
	&palettegads[2], 300, 78, 216, 8, GFLG_GADGHNONE, GACT_IMMEDIATE | GACT_FOLLOWMOUSE | GACT_RELVERIFY, GTYP_PROPGADGET, (APTR) & paletteimage[1], NULL, NULL, 0, (APTR) & paletteprop[1], PALETTE_SLIDER + 1, NULL},
	{
	&palettegads[3], 300, 91, 216, 8, GFLG_GADGHNONE, GACT_IMMEDIATE | GACT_FOLLOWMOUSE | GACT_RELVERIFY, GTYP_PROPGADGET, (APTR) & paletteimage[2], NULL, NULL, 0, (APTR) & paletteprop[2], PALETTE_SLIDER + 2, NULL},
	{
	&palettegads[4], 254, 65, 36, 8, GFLG_GADGHCOMP | GFLG_STRINGEXTEND | GFLG_TABCYCLE, GACT_RELVERIFY | GACT_TOGGLESELECT | GACT_LONGINT | GACT_STRINGRIGHT, GTYP_STRGADGET, NULL, NULL, NULL, 0, (APTR) & palettesinfo[0], PALETTE_STRING, NULL},
	{
	&palettegads[5], 254, 78, 36, 8, GFLG_GADGHCOMP | GFLG_STRINGEXTEND | GFLG_TABCYCLE, GACT_RELVERIFY | GACT_TOGGLESELECT | GACT_LONGINT | GACT_STRINGRIGHT, GTYP_STRGADGET, NULL, NULL, NULL, 0, (APTR) & palettesinfo[1], PALETTE_STRING + 1, NULL},
	{
NULL, 254, 91, 36, 8, GFLG_GADGHCOMP | GFLG_STRINGEXTEND | GFLG_TABCYCLE, GACT_RELVERIFY | GACT_TOGGLESELECT | GACT_LONGINT | GACT_STRINGRIGHT, GTYP_STRGADGET, NULL, NULL, NULL, 0, (APTR) & palettesinfo[2], PALETTE_STRING + 2, NULL}}, coloursgad =

{
NULL, 254, 16, 244, 14, GFLG_GADGHCOMP, GACT_RELVERIFY, GTYP_BOOLGADGET, NULL, NULL, NULL, GAD_CYCLE, NULL, COLOURS_SELECT, NULL}, screenmodegads[7] =

{
	{&screenmodegads[1], 303, 82, 58, 8, GFLG_GADGHCOMP | GFLG_STRINGEXTEND | GFLG_TABCYCLE, GACT_RELVERIFY | GACT_TOGGLESELECT | GACT_LONGINT, GTYP_STRGADGET, NULL, NULL, NULL, 0, (APTR) & screenwidthsinfo, SCREENMODE_WIDTH, NULL},
	{&screenmodegads[2], 303, 97, 58, 8, GFLG_GADGHCOMP | GFLG_STRINGEXTEND | GFLG_TABCYCLE, GACT_RELVERIFY | GACT_TOGGLESELECT | GACT_LONGINT, GTYP_STRGADGET, NULL, NULL, NULL, 0, (APTR) & screenheightsinfo, SCREENMODE_HEIGHT, NULL},
	{&screenmodegads[3], 303, 112, 32, 8, GFLG_DISABLED | GFLG_GADGHCOMP | GFLG_STRINGEXTEND | GFLG_TABCYCLE, GACT_RELVERIFY | GACT_TOGGLESELECT | GACT_LONGINT, GTYP_STRGADGET, NULL, NULL, NULL, 0, (APTR) & screendepthsinfo, SCREENMODE_DEPTH, NULL},
	{&screenmodegads[4], 381, 81, 26, 11, GFLG_GADGIMAGE | GFLG_GADGHIMAGE, GACT_RELVERIFY | GACT_TOGGLESELECT, GTYP_BOOLGADGET, (APTR) & copy_checkoffimage, (APTR) & copy_checkonimage, NULL, GAD_CHECK, NULL, SCREENMODE_DEFWIDTH, NULL},
	{&screenmodegads[5], 381, 96, 26, 11, GFLG_GADGIMAGE | GFLG_GADGHIMAGE, GACT_RELVERIFY | GACT_TOGGLESELECT, GTYP_BOOLGADGET, (APTR) & copy_checkoffimage, (APTR) & copy_checkonimage, NULL, GAD_CHECK, NULL, SCREENMODE_DEFHEIGHT, NULL},
	{&screenmodegads[6], 299, 126, 26, 11, GFLG_GADGIMAGE | GFLG_GADGHIMAGE, GACT_RELVERIFY | GACT_TOGGLESELECT, GTYP_BOOLGADGET, (APTR) & copy_checkoffimage, (APTR) & copy_checkonimage, NULL, GAD_CHECK, NULL, SCREENMODE_HALFHEIGHT, NULL},
	{NULL, 345, 112, 165, 8, GFLG_DISABLED | GFLG_GADGHNONE, GACT_RELVERIFY, GTYP_PROPGADGET, (APTR) & screenmodeimage, NULL, NULL, 0, (APTR) & screenmodeprop, SCREENMODE_SLIDER, NULL}
}, formatgads[11 /* HUX: was 10 */ ] =

{
	{
	&formatgads[1], 366, 19, 150, 14, GFLG_GADGHCOMP, GACT_RELVERIFY, GTYP_BOOLGADGET, NULL, NULL, NULL, GAD_CYCLE, NULL, FORMAT_WINDOW, NULL},
//HUX
	{
	&formatgads[2], 417, 183, 26, 11, GFLG_GADGIMAGE | GFLG_GADGHIMAGE, GACT_RELVERIFY | GACT_TOGGLESELECT, GTYP_BOOLGADGET, (APTR) & copy_checkoffimage, (APTR) & copy_checkonimage, NULL, GAD_CHECK, NULL, FORMAT_SIZEKMG, NULL},
//HUX
	{
	&formatgads[3], 465, 123, 104, 12, GFLG_GADGHCOMP, GACT_RELVERIFY, GTYP_BOOLGADGET, NULL, NULL, NULL, 0, NULL, FORMAT_RESET, NULL},
	{
	&formatgads[4], 465, 137, 104, 12, GFLG_GADGHCOMP, GACT_RELVERIFY, GTYP_BOOLGADGET, NULL, NULL, NULL, 0, NULL, FORMAT_CLEAR, NULL},
	{
		&formatgads[5], 417, 167, 208, 14,	// JRZ
	GFLG_GADGHCOMP, GACT_RELVERIFY, GTYP_BOOLGADGET, NULL, NULL, NULL, GAD_CYCLE, NULL, FORMAT_SEPARATE, NULL},
	{
	&formatgads[6], 417, 183, 26, 11, GFLG_GADGIMAGE | GFLG_GADGHIMAGE, GACT_RELVERIFY | GACT_TOGGLESELECT, GTYP_BOOLGADGET, (APTR) & copy_checkoffimage, (APTR) & copy_checkonimage, NULL, GAD_CHECK, NULL, FORMAT_REVERSESORT, NULL},
	{
	&formatgads[7], 552, 52, 40, 8, GFLG_GADGHCOMP | GFLG_STRINGEXTEND | GFLG_TABCYCLE, GACT_RELVERIFY | GACT_TOGGLESELECT | GACT_LONGINT, GTYP_STRGADGET, NULL, NULL, NULL, 0, (APTR) & formatlensinfo[0], FORMAT_LENGTH + 0, NULL},
	{
	&formatgads[8], 552, 78, 40, 8, GFLG_GADGHCOMP | GFLG_STRINGEXTEND | GFLG_TABCYCLE, GACT_RELVERIFY | GACT_TOGGLESELECT | GACT_LONGINT, GTYP_STRGADGET, NULL, NULL, NULL, 0, (APTR) & formatlensinfo[1], FORMAT_LENGTH + 1, NULL},
	{
	NULL, 552, 91, 40, 8, GFLG_GADGHCOMP | GFLG_STRINGEXTEND | GFLG_TABCYCLE, GACT_RELVERIFY | GACT_TOGGLESELECT | GACT_LONGINT, GTYP_STRGADGET, NULL, NULL, NULL, 0, (APTR) & formatlensinfo[2], FORMAT_LENGTH + 2, NULL},
	{
	&formatgads[10], 552, 104, 40, 8, GFLG_GADGHCOMP | GFLG_STRINGEXTEND | GFLG_TABCYCLE, GACT_RELVERIFY | GACT_TOGGLESELECT | GACT_LONGINT, GTYP_STRGADGET, NULL, NULL, NULL, 0, (APTR) & formatlensinfo[3], FORMAT_LENGTH + 3, NULL},
	{
NULL, 552, 117, 40, 8, GFLG_GADGHCOMP | GFLG_STRINGEXTEND | GFLG_TABCYCLE, GACT_RELVERIFY | GACT_TOGGLESELECT | GACT_LONGINT, GTYP_STRGADGET, NULL, NULL, NULL, 0, (APTR) & formatlensinfo[4], FORMAT_LENGTH + 4, NULL}}, icongads[4] =

{
	{
	&icongads[1], 140, 137, 28, 14, GFLG_GADGHCOMP, GACT_RELVERIFY, GTYP_BOOLGADGET, NULL, NULL, NULL, GAD_GLASS, NULL, ICON_ICONREQ, NULL},
	{
	&icongads[2], 176, 140, 275, 8, GFLG_GADGHCOMP | GFLG_STRINGEXTEND | GFLG_TABCYCLE, GACT_RELVERIFY | GACT_TOGGLESELECT, GTYP_STRGADGET, NULL, NULL, NULL, 1, (APTR) & funcsinfo, ICON_ICONPATH, NULL},
	{
	&icongads[3], 140, 165, 28, 14, GFLG_GADGHCOMP, GACT_RELVERIFY, GTYP_BOOLGADGET, NULL, NULL, NULL, GAD_GLASS, NULL, ICON_TOOLREQ, NULL},
	{
NULL, 176, 168, 275, 8, GFLG_GADGHCOMP | GFLG_STRINGEXTEND | GFLG_TABCYCLE, GACT_RELVERIFY | GACT_TOGGLESELECT, GTYP_STRGADGET, NULL, NULL, NULL, 1, (APTR) & pathsinfo, ICON_TOOLPATH, NULL}}, hotkeymmbgad =

{
NULL, 138, 97, 26, 11, GFLG_GADGIMAGE | GFLG_GADGHIMAGE, GACT_RELVERIFY | GACT_TOGGLESELECT, GTYP_BOOLGADGET, (APTR) & copy_checkoffimage, (APTR) & copy_checkonimage, NULL, GAD_CHECK, NULL, HOTKEY_MMB, NULL}, hotkeygad =

{
&hotkeymmbgad, 514, 82, 104, 12, GFLG_GADGHCOMP, GACT_RELVERIFY | GACT_TOGGLESELECT, GTYP_BOOLGADGET, NULL, NULL, NULL, 0, NULL, HOTKEY_SAMPLE, NULL}, arrowgadgets[8] =

{
	{
	&arrowgadgets[1], 237, 111, 15, 9, GFLG_GADGIMAGE | GFLG_GADGHIMAGE, GACT_IMMEDIATE | GACT_TOGGLESELECT, GTYP_BOOLGADGET, NULL, NULL, NULL, GAD_RADIO, NULL, ARROWBASE, NULL},
	{
	&arrowgadgets[2], 237, 121, 15, 9, GFLG_GADGIMAGE | GFLG_GADGHIMAGE, GACT_IMMEDIATE | GACT_TOGGLESELECT, GTYP_BOOLGADGET, NULL, NULL, NULL, GAD_RADIO, NULL, ARROWBASE + 1, NULL},
	{
	&arrowgadgets[3], 237, 131, 15, 9, GFLG_GADGIMAGE | GFLG_GADGHIMAGE, GACT_IMMEDIATE | GACT_TOGGLESELECT, GTYP_BOOLGADGET, NULL, NULL, NULL, GAD_RADIO, NULL, ARROWBASE + 2, NULL},
	{
	&arrowgadgets[4], 420, 155, 14, 11, GFLG_GADGHCOMP, GACT_RELVERIFY | GACT_IMMEDIATE, GTYP_BOOLGADGET, NULL, NULL, NULL, 0, NULL, ARROWBASE + 3, NULL},
	{
	&arrowgadgets[5], 454, 155, 14, 11, GFLG_GADGHCOMP, GACT_RELVERIFY | GACT_IMMEDIATE, GTYP_BOOLGADGET, NULL, NULL, NULL, 0, NULL, ARROWBASE + 4, NULL},
	{
	&arrowgadgets[6], 436, 149, 16, 11, GFLG_GADGHCOMP, GACT_RELVERIFY | GACT_IMMEDIATE, GTYP_BOOLGADGET, NULL, NULL, NULL, 0, NULL, ARROWBASE + 5, NULL},
	{
	&arrowgadgets[7], 436, 161, 16, 11, GFLG_GADGHCOMP, GACT_RELVERIFY | GACT_IMMEDIATE, GTYP_BOOLGADGET, NULL, NULL, NULL, 0, NULL, ARROWBASE + 6, NULL},
	{
NULL, 247, 23, 248, 14, GFLG_GADGHCOMP, GACT_RELVERIFY, GTYP_BOOLGADGET, NULL, NULL, NULL, GAD_CYCLE, NULL, ARROWCYCLE, NULL}}, fontsizegadget =

{
NULL, 570, 85, 44, 8, GFLG_GADGHCOMP | GFLG_STRINGEXTEND | GFLG_TABCYCLE, GACT_RELVERIFY | GACT_TOGGLESELECT | GACT_STRINGCENTER, GTYP_STRGADGET, NULL, NULL, NULL, 0, (APTR) & fontsizesinfo, FONT_SIZE, NULL}, editclassgadgets[14] =

{
	{
	&editclassgadgets[1], 97, 87, 352, 8, GFLG_GADGHCOMP | GFLG_STRINGEXTEND | GFLG_TABCYCLE, GACT_RELVERIFY | GACT_TOGGLESELECT, GTYP_STRGADGET, NULL, NULL, NULL, 0, (APTR) & namesinfo, CLASS_TYPE, NULL},
	{
	&editclassgadgets[2], 540, 87, 88, 8, GFLG_GADGHCOMP | GFLG_STRINGEXTEND | GFLG_TABCYCLE, GACT_RELVERIFY | GACT_TOGGLESELECT, GTYP_STRGADGET, NULL, NULL, NULL, 0, (APTR) & typeidsinfo, CLASS_TYPEID, NULL},
	{
	&editclassgadgets[3], 28, 169, 104, 12, GFLG_GADGHCOMP, GACT_RELVERIFY, GTYP_BOOLGADGET, NULL, NULL, NULL, 0, NULL, CLASS_NEWENTRY, NULL},
	{
	&editclassgadgets[4], 188, 169, 104, 12, GFLG_GADGHCOMP, GACT_RELVERIFY, GTYP_BOOLGADGET, NULL, NULL, NULL, 0, NULL, CLASS_DUPLICATE, NULL},
	{
	&editclassgadgets[5], 348, 169, 104, 12, GFLG_GADGHCOMP, GACT_RELVERIFY | GACT_TOGGLESELECT, GTYP_BOOLGADGET, NULL, NULL, NULL, 0, NULL, CLASS_SWAP, NULL},
	{
	&editclassgadgets[6], 508, 169, 104, 12, GFLG_GADGHCOMP, GACT_RELVERIFY, GTYP_BOOLGADGET, NULL, NULL, NULL, 0, NULL, CLASS_DELETE, NULL},
	{
	&editclassgadgets[7], 9, 151, 28, 14, GFLG_GADGHCOMP, GACT_RELVERIFY, GTYP_BOOLGADGET, NULL, NULL, NULL, 0, NULL, CLASS_OPERATION, NULL},
	{
	&editclassgadgets[8], 167, 154, 458, 8, GFLG_GADGHCOMP | GFLG_STRINGEXTEND | GFLG_TABCYCLE, GACT_RELVERIFY | GACT_TOGGLESELECT, GTYP_STRGADGET, NULL, NULL, NULL, 1, (APTR) & funcsinfo, CLASS_FUNC, NULL},
	{
	&editclassgadgets[9], 106, 16, 28, 14, GFLG_GADGHCOMP, GACT_RELVERIFY, GTYP_BOOLGADGET, NULL, NULL, NULL, GAD_GLASS, NULL, CLASS_FILEVIEWREQ, NULL},
	{
	&editclassgadgets[10], 142, 19, 386, 8, GFLG_GADGHCOMP | GFLG_STRINGEXTEND | GFLG_TABCYCLE, GACT_RELVERIFY | GACT_TOGGLESELECT, GTYP_STRGADGET, NULL, NULL, NULL, 1, (APTR) & pathsinfo, CLASS_FILEVIEW, NULL},
	{
	&editclassgadgets[11], 536, 16, 95, 14, GFLG_GADGHCOMP, GACT_RELVERIFY, GTYP_BOOLGADGET, NULL, NULL, NULL, GAD_CYCLE, NULL, CLASS_HEXDEC, NULL},
	{
	&editclassgadgets[12], 522, 34, 8, 30, GFLG_GADGHNONE, GACT_IMMEDIATE | GACT_FOLLOWMOUSE | GACT_RELVERIFY, GTYP_PROPGADGET, (APTR) & fileviewimage, NULL, NULL, 0, (APTR) & fileviewprop, CLASS_VIEWSLIDER, NULL},
	{
	&editclassgadgets[13], 518, 66, 16, 8, GFLG_GADGHCOMP, GACT_IMMEDIATE | GACT_RELVERIFY, GTYP_BOOLGADGET, NULL, NULL, NULL, 0, NULL, CLASS_VIEWUP, NULL},
	{
NULL, 518, 74, 16, 8, GFLG_GADGHCOMP, GACT_IMMEDIATE | GACT_RELVERIFY, GTYP_BOOLGADGET, NULL, NULL, NULL, 0, NULL, CLASS_VIEWDOWN, NULL}}, screen_sliders_gadgets[] =

{
	{
	&screen_sliders_gadgets[1], 229, 11, 97, 14, GFLG_GADGHCOMP, GACT_RELVERIFY, GTYP_BOOLGADGET, NULL, NULL, NULL, GAD_CYCLE, NULL, SCREEN_SLIDER_LEFTCYCLE, NULL},
	{
NULL, 420, 11, 97, 14, GFLG_GADGHCOMP, GACT_RELVERIFY, GTYP_BOOLGADGET, NULL, NULL, NULL, GAD_CYCLE, NULL, SCREEN_SLIDER_RIGHTCYCLE, NULL}};

//extern USHORT glass_data[2][];
extern CONST USHORT glass_data[2][18];
extern CONST USHORT uparrow_data[];
extern CONST USHORT downarrow_data[];

char *windownames[2], *separatenames[3];

CONST int gadflagvals[] = {
	FF_AUTOICONIFY, FF_CDDEST, FF_CDSOURCE, FF_DOPUS2F, FF_DOALLFILES,
	FF_DOPUSSTARTUP, FF_SHELLSTARTUP, FF_NOQUOTE, FF_OUTPUTFILE,
	FF_OUTPUTWIN,
	FF_RECURSEDIR, FF_RELOADFILE, FF_RESCANDEST, FF_RESCANSOURCE,
	FF_RUNASYNC, FF_WB2F
};

CONST short editfuncgadgets_xy[15][2] = {
	{254, 42},
	{508, 54},
	{21, 68},
	{21, 81},
...

{
	...
	252, 66},
	{
252, 79}}, coloursgad_xy[2] =

{
252, 4}, screenmodegads_xy[7][2] =

{
	...
	297, 111},
	{
343, 97}}, formatgads_xy[11 /* HUX: was 10 */ ][2] =
...

{
	...
	138, 153},
	{
174, 156}}, hotkeymmbgad_xy[2] =

{
136, 85}, hotkeygad_xy[2] =

{
512, 70}, arrowgadgets_xy[8][2] =

{
	...
	434, 149},
	{
245, 11}}, fontsizegadget_xy[2] =

{
568, 73}, editclassgadgets_xy[14][2] =

{
	...
	514, 54},
	{
514, 62}}, screen_sliders_gadgets_xy[2][2] =
