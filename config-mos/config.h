...
extern TEXT filebuf[256], dirbuf[258];
...
extern CONST UWORD drawinfo[];
extern int lchanged, changed;

extern struct Image *checkonimage, *checkoffimage, *buttononimage, *buttonoffimage, copy_checkonimage, copy_checkoffimage;
...
extern CONST struct ColourSel coloursel[];

extern char *mainmenugads[14], *listviewgads[3], *listviewgads2[4], *operationgads[14], *systemgads[14], *gadgetgads[11], *functypelist[], ftype_funcmap[], *functypestr[], *editfuncgads[6], *editfuncgads2[16], *gadflaglist[17], *editclassgads[10], *menugadgets[11], *drivegadgets[11], *drivegadgets2[5], *screengadgets[14], *formatgadgets[11], *hotkeygadgets[3], *arrowgadtxt[4], *arrowtypetxt[3], *filetypeactiongadgets[11], *commandlist[95], *arglist[18], *classopslist[], *formatnames[FORMAT_MAXNUM + 1], *selectedformatnames[FORMAT_MAXNUM + 1], *palettegadgets[], *coloursgadgets[], *screenmodegadgets[], *hotkeysgadgets[], *windownames[2], *errorcheckingtxt[], *separatenames[3];
extern CONST CONST_STRPTR defdir[];

extern CONST struct ConfigGadget *operationgadgets[8], *systemgadgets[9], scr_generalgadgets[];
...
extern CONST CONST_STRPTR external_module_list[], external_module_name[];
extern CONST int external_module_map[];
...
extern char edit_namebuf[256], edit_stackbuf[7], edit_prioritybuf[5], edit_delaybuf[3], edit_funcbuf[256], edit_pathbuf[256], edit_actionbuf[40], palette_buf[3][4], screenwidth_buf[6], screenheight_buf[6], screendepth_buf[4], formatlen_buf[5][8], fontsize_buf[12], edit_typeidbuf[8];

extern struct StringInfo namesinfo, funcsinfo;

extern CONST USHORT glass_data[2][18], uparrow_data[6], downarrow_data[6];
extern CONST USHORT leftarrow_data[6], rightarrow_data[6];
extern CONST USHORT pageflip_data1[5], pageflip_data2[3];
...
extern struct MenuItem projectitems[], edititems[], gadrowsitems[], classitems[], neatstuffitem;
...
extern char *fontdatabuf, **fontlist, *(**fontsizelist), **noproplist, *(**nopropsizelist), **only8list, *only8sizelist[];

extern CONST int gadflagvals[];
...
extern CONST CONST_STRPTR ftype_funcs[];

extern struct StringData stringdata;

extern CONST short func_list_items[];
...
extern CONST short editfuncgadgets_xy[15][2], editdrivegadgets_xy[4][2], menuslidergads_xy[3][2], palettegads_xy[6][2], coloursgad_xy[2], screenmodegads_xy[7][2], formatgads_xy[11][2], icongads_xy[4][2], hotkeymmbgad_xy[2], hotkeygad_xy[2], arrowgadgets_xy[8][2], fontsizegadget_xy[2], editclassgadgets_xy[14][2], screen_sliders_gadgets_xy[2][2];
