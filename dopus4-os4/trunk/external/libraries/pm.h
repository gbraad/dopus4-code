...
#define PMMenu(t)	IPopupMenu->PM_MakeMenu(\
			PM_Item, IPopupMenu->PM_MakeItem(PM_Hidden, TRUE, TAG_DONE),\
			PM_Item, IPopupMenu->PM_MakeItem(PM_Title, t, PM_NoSelect, TRUE, PM_ShinePen, TRUE, PM_Shadowed, TRUE, PM_Center, TRUE, TAG_DONE),\
			PM_Item, IPopupMenu->PM_MakeItem(PM_WideTitleBar, TRUE, TAG_DONE)
#define PMMenuID(t)	IPopupMenu->PM_MakeMenu(\
			PM_Item, IPopupMenu->PM_MakeItem(PM_Hidden, TRUE, TAG_DONE),\
			PM_Item, IPopupMenu->PM_MakeItem(PM_TitleID, t, PM_NoSelect, TRUE, PM_ShinePen, TRUE, PM_Shadowed, TRUE, PM_Center, TRUE, TAG_DONE),\
			PM_Item, IPopupMenu->PM_MakeItem(PM_WideTitleBar, TRUE, TAG_DONE)
#define PMSubMenu(t)	PM_Sub, IPopupMenu->PM_MakeMenu(PM_Item, IPopupMenu->PM_MakeItem(PM_Title, t, PM_NoSelect, TRUE, PM_ShinePen, TRUE, TAG_DONE),\
			PM_Item, IPopupMenu->PM_MakeItem(PM_WideTitleBar, TRUE, TAG_DONE)
#define PMSimpleSub	PM_Sub, IPopupMenu->PM_MakeMenu(PM_Dummy, 0
#define PMItem(t)	PM_Item, IPopupMenu->PM_MakeItem(PM_Title, t
#define PMItemID(t)	PM_Item, IPopupMenu->PM_MakeItem(PM_TitleID, t
#define PMInfo(t)	PM_Item, IPopupMenu->PM_MakeItem(PM_Title, t, PM_NoSelect, TRUE, PM_ShinePen, TRUE
#define PMColBox(c)	PM_Item, IPopupMenu->PM_MakeItem(PM_ColourBox, c
#define PMBar		PM_Item, IPopupMenu->PM_MakeItem(PM_TitleBar, TRUE
#define PMMenuTitle(t)	PM_Item, IPopupMenu->PM_MakeItem(PM_Title, t, PM_NoSelect, TRUE, PM_ShinePen, TRUE, PM_Shadowed, TRUE, PM_Center, TRUE, TAG_DONE),\
			PM_Item, IPopupMenu->PM_MakeItem(PM_WideTitleBar, TRUE, TAG_DONE)
#define PMHoriz		PM_Item, IPopupMenu->PM_MakeItem(PM_NoSelect, TRUE, PM_LayoutMode, PML_Horizontal
#define PMVert		PM_Item, IPopupMenu->PM_MakeItem(PM_NoSelect, TRUE, PM_LayoutMode, PML_Vertical
#define PMMembers	PM_Members, IPopupMenu->PM_MakeMenu(PM_Dummy, 0

#define PMExcl		PM_Exclude, IPopupMenu->PM_MakeIDList(
...
#define PMCheckItem(t,id)	PM_Item, IPopupMenu->PM_MakeItem(PM_Title, t, PM_ID, id, PM_Checkit, TRUE

#define PMMXItem(t,id)	PM_Item, IPopupMenu->PM_MakeItem(PM_Title, t, PM_ID, id, PM_Checkit, TRUE, PM_Toggle, FALSE
