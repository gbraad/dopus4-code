...
extern struct DOpusMessage msg;
...
extern USHORT glass_data[2][18], uparrow_data[6], downarrow_data[6], leftarrow_data[6], rightarrow_data[6], pageflip_data1[5], pageflip_data2[3];
