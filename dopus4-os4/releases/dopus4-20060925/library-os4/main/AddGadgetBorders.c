...
void _DOpus_AddGadgetBorders(struct DOpusIFace *Self, struct DOpusRemember **key, struct Gadget *gadget, int count, int shine, int shadow)
{
	...
	Self->CreateGadgetBorders(key, gadget->Width, gadget->Height, &selborder, &unselborder, 0, shine, shadow);
