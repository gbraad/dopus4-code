...
UQUAD dos_global_bytecount /*=0*/ ;			/* Global byte count from recursive op */
//unsigned long long dos_global_copiedbytes /*=0*/ ;	/* Bytes copied in a recursive op */
UQUAD dos_global_copiedbytes /*=0*/ ;			/* Bytes copied in a recursive op */
//unsigned long long dos_global_deletedbytes /*=0*/ ;	/* Bytes copied in a recursive op */
UQUAD dos_global_deletedbytes /*=0*/ ;			/* Bytes copied in a recursive op */
