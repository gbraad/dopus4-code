...
STATIC CONST struct TagItem select_base_gadget[] =
{
...
{
	ULONG class = 0, gadgetid = 0, code = 0;
	...
	if(!(swindow = OpenRequester(&select_req)) || !(gadlist = addreqgadgets(&select_req, select_gadgets, 0, NULL)) || !(AddRequesterObject(&select_req, select_title_text)))
	{
