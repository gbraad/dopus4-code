...
STATIC CONST struct TagItem rename_oldname_gadget[] =
{
...
{
	ULONG class, code, gadgetid = 0, qual;
	...
	if(!(rwindow = OpenRequester(&rename_req)) || !(gadlist = addreqgadgets(&rename_req, rename_gadgets, 0, NULL)))
	{
