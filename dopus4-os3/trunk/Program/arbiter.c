...
#ifdef __MORPHOS__
        &CreateNewProc(arbiter_tags)->pr_MsgPort)) return(0);
#else
        &CreateNewProcTags(NP_Name,(Tag)"dopus_arbiter",NP_Priority,0,NP_Seglist,(long)arbiter_seglist>>2,NP_StackSize,4000,NP_FreeSeglist,FALSE,TAG_END)->pr_MsgPort)) return(0);
#endif
