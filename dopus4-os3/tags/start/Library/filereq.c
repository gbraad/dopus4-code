...
*/
int __regargs gettingdirmsg(struct FileReqData *freqdata,ULONG class,USHORT code,USHORT qual,USHORT gadgetid);
...
int __regargs getintuimsg(struct Window *win,ULONG *class,USHORT *code,USHORT *qual,USHORT *gadgetid)
{
...
int __regargs do_idcmp(struct FileReqData *freqdata,ULONG class,USHORT code,USHORT qual,USHORT gadgetid)
{
