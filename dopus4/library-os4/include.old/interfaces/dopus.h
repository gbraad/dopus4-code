...
struct DOpusIFace
{
	...
	void APICALL (*StampToStr)(struct DOpusIFace *Self, struct DOpusDateTime * datetime);
	int APICALL (*StrToStamp)(struct DOpusIFace *Self, struct DOpusDateTime * datetime);
