...
#define LParsePattern(pat, parsepat) IDOpus->LParsePattern(pat, parsepat) 
#define LMatchPattern(parsepat, str) IDOpus->LMatchPattern(parsepat, str) 
#define LParsePatternI(pat, parsepat) IDOpus->LParsePatternI(pat, parsepat) 
#define LMatchPatternI(parsepat, str) IDOpus->LMatchPatternI(parsepat, str) 
